...
│ INTAKES TABLE                                              │
│ ┌──┬──────────────────┬──────────┬──────────┬────────┐
│ │☐ │ Client           │ Category │ Status   │ Created │
│ ├──┼──────────────────┼──────────┼──────────┼────────┤
│ │☑ │ John Doe         │Employment│ ⓘ IN PRG │ 6/1/26 │
│ │  │ john@example.com │          │          │       │        │
│ ├──┼──────────────────┼──────────┼──────────┼───────┼────────┤
...
│                                                          │
│ 9:20 AM                                                 │
│ Searches for "employment" in all statuses              │
│ Finds 5 employment cases, reviews all                  │
│                                                          │
│ 9:25 AM                                                 │
...
Solution:
  Step 1: Check filter settings (status)
